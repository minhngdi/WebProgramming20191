...
<body>
    <div class="h4 text-center border border-light p-2">
        ...
        <p>
        <a href="./signup.php">
                <button type="button" class="btn">Sign up new</button>
        </a>
        </p>
    </div>
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td><a href="./delete.php?id=<?php echo $row['id'] ?>"><button type="button" class="btn btn-danger" onclick="return confirm('Are you sure?')">Delete</button></a></button>
                    </tr>
                <?php
                }
                ?>
